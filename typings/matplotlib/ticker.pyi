...
class LogFormatter(Formatter):
    ...
    def __init__(
        self, base=..., labelOnlyBase=..., minor_thresholds=..., linthresh=...
    ) -> None: ...
...
class EngFormatter(Formatter):
    ...
    ENG_PREFIXES = ...
    def __init__(
        self, unit=..., places=..., sep=..., *, usetex=..., useMathText=...
    ) -> None:
        r"""
        Parameters
        ----------
...
def scale_range(
    vmin, vmax, n=..., threshold=...
):  # -> tuple[float, float | Literal[0]]:
    ...
...
class AsinhLocator(Locator):
    ...
    def __init__(
        self, linear_width, numticks=..., symthresh=..., base=..., subs=...
    ) -> None:
        """
        Parameters
        ----------
