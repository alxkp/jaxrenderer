...
def get_registered_canvas_class(format):  # -> Any | None:
    """
...
class TimerBase:
    ...
    def __init__(self, interval=..., callbacks=...) -> None:
        """
        Parameters
        ----------
...
class LocationEvent(Event):
    ...
    lastevent = ...
    def __init__(self, name, canvas, x, y, guiEvent=..., *, modifiers=...) -> None: ...
...
class PickEvent(Event):
    ...
    def __init__(
        self, name, canvas, mouseevent, artist, guiEvent=..., **kwargs
    ) -> None: ...
...
class KeyEvent(LocationEvent):
    ...
    def __init__(self, name, canvas, key, x=..., y=..., guiEvent=...) -> None: ...
...
class FigureCanvasBase:
    ...
    def button_press_event(self, x, y, button, dblclick=..., guiEvent=...):  # -> None:
        """
    ...
    def enter_notify_event(self, guiEvent=..., *, xy):  # -> None:
        """
    ...
    def new_timer(self, interval=..., callbacks=...):  # -> _timer_cls:
        """
...
class ToolContainerBase:
    ...
    def add_tool(self, tool, group, position=...):  # -> None:
        """
