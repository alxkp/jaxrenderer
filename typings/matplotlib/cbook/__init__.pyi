...
def to_filehandle(
    fname, flag=..., return_opened=..., encoding=...
):  # -> tuple[GzipFile | TextIO | BZ2File | IO[Any] | Unknown, bool] | GzipFile | TextIO | BZ2File | IO[Any]:
    """
...
def open_file_cm(
    path_or_file, mode=..., encoding=...
):  # -> GzipFile | TextIO | BZ2File | IO[Any] | bytes | str | Any | nullcontext[GzipFile | TextIO | BZ2File | IO[Any] | Unknown | bytes | str | Any]:
...
def get_sample_data(
    fname, asfileobj=..., *, np_load=...
):  # -> GzipFile | Any | BufferedReader | TextIOWrapper | str:
    """
...
def boxplot_stats(
    X, whis=..., bootstrap=..., labels=..., autorange=...
):  # -> list[Unknown]:
    r"""
...
def index_of(
    y,
):  # -> tuple[Unknown, Unknown] | tuple[NDArray[Any], NDArray[Unknown] | ndarray[Unknown, Unknown] | Unknown]:
    """
