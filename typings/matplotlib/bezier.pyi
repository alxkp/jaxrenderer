...
def get_intersection(
    cx1, cy1, cos_t1, sin_t1, cx2, cy2, cos_t2, sin_t2
...
def split_de_casteljau(beta, t):  # -> tuple[list[Any], list[Any]]:
    """
...
def find_bezier_t_intersecting_with_closedpath(
    bezier_point_at_t, inside_closedpath, t0=..., t1=..., tolerance=...
):  # -> tuple[float, float]:
    """
...
class BezierSegment:
    ...
    def __call__(self, t):  # -> NDArray[signedinteger[Any]]:
        """
...
def split_bezier_intersecting_with_closedpath(
    bezier, inside_closedpath, tolerance=...
...
def split_path_inout(
    path, inside, tolerance=..., reorder_inout=...
):  # -> tuple[Path, Path]:
    """
...
def inside_circle(cx, cy, r):  # -> (xy: Unknown) -> Unknown:
    """
...
def get_cos_sin(x0, y0, x1, y1):  # -> tuple[float, float] | tuple[Unknown, Unknown]:
    ...

def check_if_parallel(dx1, dy1, dx2, dy2, tolerance=...):  # -> Literal[1, -1, False]:
    """
...
def get_parallels(
    bezier2, width
):  # -> tuple[list[tuple[Unknown, Unknown]], list[tuple[Unknown, Unknown]]]:
    """
